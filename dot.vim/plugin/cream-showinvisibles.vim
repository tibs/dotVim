...
" can edit this file.
	...
	if     strlen(substitute(strtrans(nr2char(183)), ".", "x", "g")) == 1
		" vertical bar |, followed by middle dot (digraph .M)
		execute "set listchars+=tab:\\|" . nr2char(183)
	else
		" vertical bar, followed by period
		execute "set listchars+=tab:\\|" . nr2char(46)
	endif
